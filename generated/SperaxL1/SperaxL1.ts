...
export class SperaxL1__timelockOfResult {
  value0: BigInt;
  value1: BigInt;
...
export class SperaxL1 extends ethereum.SmartContract {
  static bind(address: Address): SperaxL1 {
    return new SperaxL1("SperaxL1", address);
  }
  ...
  timelockOf(account: Address): SperaxL1__timelockOfResult {
    let result = super.call(
      "timelockOf",
    ...
    return new SperaxL1__timelockOfResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_timelockOf(
    account: Address
  ): ethereum.CallResult<SperaxL1__timelockOfResult> {
    let result = super.tryCall(
      "timelockOf",
      "timelockOf(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new SperaxL1__timelockOfResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
